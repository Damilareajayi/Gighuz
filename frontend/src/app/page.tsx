      ...
      <div className="relative overflow-hidden">
        ...
        <section className="relative max-w-6xl mx-auto px-6 pt-10 pb-14 lg:pb-28 grid lg:grid-cols-[1.1fr_0.9fr] gap-12 items-center">
          <div className="text-center lg:text-left">
            ...
            <Link href="/install"
              className="mt-6 inline-flex items-center gap-3 text-xs text-gray-500 hover:text-teal-700 border border-surface-border hover:border-teal-200 rounded-xl px-4 py-2.5 transition-colors">
              <span className="flex items-center gap-1.5">
                <Apple size={14} /> <AndroidIcon size={14} /> <Monitor size={14} />
              </span>
              <span className="w-px h-3.5 bg-surface-border" />
